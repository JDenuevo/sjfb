...
<body class="bg-gray-50">
  ...
  <div class="sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 lg:px-8 lg:hidden">
    <div class="flex items-center py-2">
      <button type="button" class="size-8 flex justify-center items-center gap-x-2 border border-gray-200 text-gray-800 hover:text-gray-500 rounded-lg focus:outline-none" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-application-sidebar" aria-label="Toggle navigation" data-hs-overlay="#hs-application-sidebar">
      ...
      <ol class="ms-3 flex items-center whitespace-nowrap">
        ...
        <li class="text-sm font-semibold text-gray-800 truncate" aria-current="page">Blogs</li>
      </ol>
    </div>
  </div>
