...
<header class="top-0 z-50 flex flex-wrap md:justify-start md:flex-nowrap w-full py-1 bg-white shadow-xs">
  <nav class="main-nav relative max-w-7xl w-full grid px-4 md:px-6 mx-auto">
    ...
    <div class="top-nav flex flex-row items-center justify-center gap-x-8">
      <a class="text-black cursor-pointer hover:text-orange-500 transition" href="<?= $baseUrl ?>/" aria-current="page">Home</a>
      <a class="text-black cursor-pointer hover:text-orange-500 transition" href="<?= $baseUrl ?>aboutus">About</a>
      <a class="text-black cursor-pointer hover:text-orange-500 transition" href="<?= $baseUrl ?>sustainability">Sustainability</a>
      <a class="text-black cursor-pointer hover:text-orange-500 transition" href="<?= $baseUrl ?>services">Services</a>
      <a class="text-black cursor-pointer hover:text-orange-500 transition" href="<?= $baseUrl ?>careers">Careers</a>
    </div>
