<div class="px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="text-center">
    <h1 class="font-medium text-black text-3xl mb-5">
      Shop our products
    </h1>
  </div>
        ...
        <form method="GET" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
          ...
          <div class="relative">
            ...
            <button type="button" id="clearSearch" 
                    class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-700 transition-colors <?php echo !isset($_GET['search']) || empty($_GET['search']) ? 'hidden' : ''; ?>">
...
<div id="productsContainer" class="relative min-h-[500px]">
  ...
  ?>
  <div class="bg-white shadow-lg rounded-lg p-5 relative group block">
