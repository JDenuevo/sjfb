                          ...
                          <div class="flex-grow">
                              ...
                              <div class="flex items-center justify-between mt-2">
                                  <div class="flex items-center border border-gray-300 rounded">
                                      <button class="px-1 py-0.5 rounded-l text-sm hover:bg-orange-600" data-product-id="<?= $item['product_id'] ?>" data-variant-id="<?= $item['variant_id'] ?>">-</button>
                                      <input type="text" class="quantity w-12 px-1 py-0.5 text-center text-sm border-0" value="<?= $item['quantity'] ?>" readonly>
                                      <button class="px-1 py-0.5 rounded-r text-sm hover:bg-orange-600" data-product-id="<?= $item['product_id'] ?>" data-variant-id="<?= $item['variant_id'] ?>">+</button>
                                  </div>
                                  <span class="price ml-4 font-medium text-sm">₱<?= number_format($item['price'] * $item['quantity'], 2) ?></span>
                              </div>
                          </div>
                          <button class="remove text-red-500 hover:text-red-700 ml-4" data-product-id="<?= $item['product_id'] ?>" data-variant-id="<?= $item['variant_id'] ?>">
