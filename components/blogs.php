...
<div class="overflow-hidden bg-orange-100">
  <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <!-- I wanted to show here the 8 latest reviews in website -->
      ...
      <div class="flex h-auto">
        <div class="flex flex-col bg-card rounded-xl">
          <div class="flex-auto p-4 md:p-6">
            <p class="text-base italic md:text-lg text-foreground">
          ...
          <div class="p-4 bg-orange-400 rounded-b-xl md:px-7">
            <div class="flex items-center gap-x-3">
              ...
              <!-- I wanted to show here in this page all reviews in website -->
              <a href="ratings.php" class="flex items-center text-xs text-white hover:underline">
                 View more 
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-chevron-right"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 6l6 6l-6 6" /></svg>              </a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
      ...
      <div>
        ...
        <p class="mt-1 text-slate-300">in fulfilling orders</p>
      </div>
      <!-- End Stats -->

      <!-- Stats -->
      <div>
        <h4 class="text-lg sm:text-xl font-semibold text-slate-500">Startup businesses</h4>
        <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-orange-600">2,000+</p>
        <p class="mt-1 text-slate-300">partner with St. Joseph Fish Brokerage Inc.</p>
      </div>
      <!-- End Stats -->

      <!-- Stats -->
      <div>
        <h4 class="text-lg sm:text-xl font-semibold text-slate-500">Happy customer</h4>
        <p class="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-orange-600">99%</p>
        <p class="mt-1 text-slate-300">this year alone</p>
      </div>
      <!-- End Stats -->
    </div>
    <!-- End Grid -->
