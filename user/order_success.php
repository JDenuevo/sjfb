  ...
  <div class="max-w-[70rem] px-4 sm:px-6 lg:px-8 mx-auto my-4 sm:my-10 mt-10">
    ...
    <div class="sm:w-11/12 lg:w-3/4 mx-auto">
      ...
      <div class="mt-6 flex justify-end gap-x-3">
        ...
        <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg text-white bg-orange-600 hover:bg-orange-700 shadow-2xs disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-gray-50" href="products.php" >
          Continue Shopping
        </a>
      </div>
      <!-- End Buttons -->
...
<script>
  document.getElementById('downloadBtn').addEventListener('click', function() {
    html2canvas(document.getElementById('orderReceipt')).then(canvas => {
      let link = document.createElement('a');
      link.href = canvas.toDataURL('image/png');
      link.download = 'download_receipt.png';
      link.click();
    });
  });
</script>
