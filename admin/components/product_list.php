            ...
            <tr>
              <td class="ps-6 py-3">
                <div class="flex items-center gap-x-3">
                  <div class="grow">
                    <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"><?= htmlspecialchars($row['product_name']) ?></span>
                    <span class="block text-sm text-gray-500 dark:text-neutral-500"><?= htmlspecialchars($row['product_description']) ?></span>
                  </div>
                </div>
              </td>
              <td class="px-6 py-3">
                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"><?= $row['product_size'] ?></span>
              </td>
              <td class="px-6 py-3">
                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"><?= $row['category_name'] ?></span>
              </td>
              <td class="px-6 py-3">
                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"><?= $row['product_stock'] ?></span>
              </td>
              <td class="px-6 py-3">
                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"><?= number_format($row['product_price'], 2) ?></span>
              </td>
              <td class="px-6 py-3">
                <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200"><?= number_format($row['discount_price'], 2) ?></span>
              </td>
              <td class="px-6 py-3">
