  ...
  <div class="relative flex flex-col h-full max-h-full">
    <div class="px-6 pt-4 flex items-center">
      ...
      <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="#" aria-label="Preline">
        <img src="../assets/icons/landscape-logo.svg" alt="St. Joseph Fish Brokerage Inc. Landscape Logo" class="w-48">
      </a>
      <!-- End Logo -->
    </div>

    <!-- Content -->
    <div class="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]: [&::-webkit-scrollbar-thumb]:bg-gray-300">
      <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="flex flex-col space-y-1">
          <li>
            <a class="flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-gray-800 rounded-lg " href="dashboard.php">
          ...
          <li>
            <a class="flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-gray-800 rounded-lg " href="orders.php">
          ...
          <li>
            <a class="flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-gray-800 rounded-lg " href="payments.php">
          ...
          <li>
            <a class="flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-gray-800 rounded-lg " href="products.php">
          ...
          <li>
            <a class="flex items-center gap-x-3.5 py-2 px-2.5  text-sm text-gray-800 rounded-lg " href="accounts.php">
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    const currentPage = window.location.pathname.split("/").pop(); // gets current file like 'products.php'
    const sidebarLinks = document.querySelectorAll("#hs-application-sidebar a");
    ...
    sidebarLinks.forEach(link => {
      ...
      if (href === currentPage) {
        link.classList.add(
          "bg-orange-500",  // highlight bg
          "text-white", // text color
          "font-semibold"  // make it stand out
        );
      } else {
