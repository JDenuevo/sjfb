  ...
  <nav class="px-4 flex basis-full items-center w-full mx-auto">
    ...
    <div class="w-full flex items-center justify-between ms-auto md:justify-between gap-x-1 md:gap-x-3">
      ...
      <div class="flex flex-row items-center justify-end gap-1">
        ...
        <a href="profile.php" class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100" href="#">
