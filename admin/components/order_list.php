              ...
              <tr>
                ...
                <td class="size-px whitespace-nowrap">
                  <div class="ps-6 ">
                    <div class="flex items-center gap-x-3">
                      <div class="grow">
                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">1</span>
                      </div>
                    </div>
                  </div>
                </td>
                ...
                <td class="size-px whitespace-nowrap">
                  <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 ">
                    <div class="px-6 ">
                      <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">Name of User or Guest</span>
                    </div>
                  </div>
                </td>
                <td class="h-px w-72 whitespace-nowrap">
                  <div class="px-6 ">
                    <div class="flex items-center gap-x-3">
                      <div class="grow">
                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">User or Guest</span>
                      </div>
                    </div>
                  </div>
                </td>
                <td class="h-px w-72 whitespace-nowrap">
                  <div class="px-6 ">
                    <div class="flex items-center gap-x-3">
                      <div class="grow">
                        <span class="block text-sm font-semibold text-gray-800 dark:text-neutral-200">28 Dec, 12:12</span>
                      </div>
                    </div>
                  </div>
                </td>
